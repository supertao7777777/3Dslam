...
void Preprocess::process(const livox_ros_driver2::CustomMsg::ConstPtr &msg, PointCloudXYZI::Ptr &pcl_out, pcl::PointCloud<pcl::PointXYZINormal>::Ptr &raw_cloud)
{  
  avia_handler(msg);
...
void Preprocess::customtopcNormal(const livox_ros_driver2::CustomMsg::ConstPtr &Msg, pcl::PointCloud<pcl::PointXYZINormal>::Ptr &raw_cloud){
  //只保存一帧
  raw_cloud->clear();
