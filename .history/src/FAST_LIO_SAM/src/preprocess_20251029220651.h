...
//   EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  void process(const livox_ros_driver2::CustomMsg::ConstPtr &msg, PointCloudXYZI::Ptr &pcl_out, pcl::PointCloud<pcl::PointXYZINormal>::Ptr &raw_cloud);
  ...
  void customtopcNormal(const livox_ros_driver2::CustomMsg::ConstPtr &msg, pcl::PointCloud<pcl::PointXYZINormal>::Ptr &raw_cloud);
